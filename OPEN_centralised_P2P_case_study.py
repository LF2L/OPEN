...
# -*- coding: utf-8 -*-
"""
This case studies focuses on a neighborhood that share energy localy using local renewable energy production and storager system. 
"""
...
#######################################
###       
### Case Study: P2P energy sharing
###        
#######################################

path_string = normpath('Results/centrelised_P2P_Case_Study/')
...
dt = 1/60 #1 minute time intervals (hours)
T = int(24/dt) #Number of intervals in one day (integer)
dt_ems = 15/60 #15 minute EMS time intervals (hours)
